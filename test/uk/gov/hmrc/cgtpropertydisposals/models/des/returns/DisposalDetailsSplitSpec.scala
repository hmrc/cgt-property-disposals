...
import uk.gov.hmrc.cgtpropertydisposals.models.generators.Generators.sample as forAll
import uk.gov.hmrc.cgtpropertydisposals.models.returns.CompleteReturn.{CompleteMultipleIndirectDisposalReturn, CompleteSingleIndirectDisposalReturn, CompleteSingleMixedUseDisposalReturn}
